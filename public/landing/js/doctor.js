      ...
      <div class="profile-hero glass-strong">
        ...
        <div class="profile-hero-content">
          ...
          <div class="profile-cta">
            ...
            <a class="btn btn-primary btn-lg" href="./booking?id=${doc.id}">
      ...
      <div class="profile-grid">
        ...
        <div>
          ...
          <div class="card">
            ...
            <a class="btn btn-primary" style="width:100%;justify-content:center;margin-top:16px;gap:8px" href="./booking?id=${doc.id}">
